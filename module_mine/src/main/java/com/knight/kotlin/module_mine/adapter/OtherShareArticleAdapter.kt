...
class OtherShareArticleAdapter(data:MutableList<MyArticleEntity>):
    BaseQuickAdapter<MyArticleEntity, BaseViewHolder>(R.layout.base_text_item,data) {
        ...
        item.run {
            ...
            if (!TextUtils.isEmpty(superChapterName) || !TextUtils.isEmpty(chapterName)) {
                ...
                if (!TextUtils.isEmpty(superChapterName)) {
                    ...
                    if (!TextUtils.isEmpty(chapterName)) { holder.setText(R.id.base_tv_article_superchaptername, chapterName)
                    } else {
