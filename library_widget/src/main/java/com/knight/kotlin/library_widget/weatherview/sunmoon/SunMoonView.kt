...
class SunMoonView @JvmOverloads constructor(
    ...
    init {
        ...
        mMargin = MARGIN_DIP.dp2px()
        iconSize = ICON_SIZE_DIP.dp2px().toInt()
    ...
    private fun ensureShader(
        ...
        mX1ShaderColors[0] = com.knight.kotlin.library_base.util.ColorUtils.blendColor(lineShadowShader, rootColor)
        mX1ShaderColors[1] = rootColor
        mX2ShaderColors[0] = com.knight.kotlin.library_base.util.ColorUtils.blendColor(lineShadowShader, mX1ShaderColors[0])
