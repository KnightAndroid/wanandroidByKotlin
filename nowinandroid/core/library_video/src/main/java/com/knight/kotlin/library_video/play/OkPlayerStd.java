...
/**
 * Author:Knight
 * Time:2024/5/11 15:44
 * Description:OkPlayerStd
 */
public class OkPlayerStd extends OkPlayer {
    ...
    public BroadcastReceiver wifiReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
                boolean isWifi = VideoUtils.isWifiConnected(context);
    ...
    public OkPlayerStd(Context context) {
        super(context);
    }

    public OkPlayerStd(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void clickRetryBtn() {
        if (jzDataSource.urlsMap.isEmpty() || jzDataSource.getCurrentUrl() == null) {
            Toast.makeText(jzvdContext, getResources().getString(R.string.vi_no_url), Toast.LENGTH_SHORT).show();
            return;
        }
        if (!jzDataSource.getCurrentUrl().toString().startsWith("file") && !
                jzDataSource.getCurrentUrl().toString().startsWith("/") &&
                !VideoUtils.isWifiConnected(jzvdContext) && !WIFI_TIP_DIALOG_SHOWED) {
            showWifiDialog();
            return;
        }
    ...
    protected void clickClarity() {
        ...
        final LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.vi_layout_clarity, null);
...
//                onStatePreparingChangeUrl();
        ...
        for (int j = 0; j < jzDataSource.urlsMap.size(); j++) {
            ...
            TextView clarityItem = (TextView) inflate(jzvdContext, R.layout.vi_layout_clarity_item, null);
        ...
        clarityPopWindow = new PopupWindow(layout, VideoUtils.dip2px(jzvdContext, 240), LayoutParams.MATCH_PARENT, true);
        clarityPopWindow.setContentView(layout);
        clarityPopWindow.setAnimationStyle(R.style.vi_pop_animation);
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    public void setScreenFullscreen() {
        ...
        fullscreenButton.setImageResource(R.drawable.vi_shrink);
        ...
        changeStartButtonSize((int) getResources().getDimension(R.dimen.vi_start_button_w_h_fullscreen));
    ...
    public void showWifiDialog() {
        ...
        builder.setNegativeButton(getResources().getString(R.string.vi_tips_not_wifi_cancel), (dialog, which) -> {
            dialog.dismiss();
            releaseAllVideos();
            clearFloatScreen();
        });
    ...
    public void setBatteryLevel() {
        ...
        if (percent < 15) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_10);
        } else if (percent >= 15 && percent < 40) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_30);
        } else if (percent >= 40 && percent < 60) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_50);
        } else if (percent >= 60 && percent < 80) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_70);
        } else if (percent >= 80 && percent < 95) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_90);
        } else if (percent >= 95 && percent <= 100) {
            batteryLevel.setBackgroundResource(R.drawable.vi_battery_level_100);
        }
    }
    ...
    public void updateStartImage() {
        if (state == STATE_PLAYING) {
            ...
            startButton.setImageResource(R.drawable.vi_click_pause_selector);
            ...
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.drawable.vi_click_replay_selector);
            replayTextView.setVisibility(VISIBLE);
        } else {
            startButton.setImageResource(R.drawable.vi_click_play_selector);
            replayTextView.setVisibility(GONE);
        }
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, long seekTimePosition, String totalTime, long totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(jzvdContext).inflate(R.layout.vi_dialog_progress, null);
        ...
        if (deltaX > 0) {
            mDialogIcon.setBackgroundResource(R.drawable.vi_forward_icon);
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.vi_backward_icon);
        }
        onCLickUiToggleToClear();
    }
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(jzvdContext).inflate(R.layout.vi_dialog_volume, null);
        ...
        if (volumePercent <= 0) {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.vi_close_volume);
        } else {
            mDialogVolumeImageView.setBackgroundResource(R.drawable.vi_add_volume);
        }
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(jzvdContext).inflate(R.layout.vi_dialog_brightness, null);
    ...
    public Dialog createDialogWithView(View localView) {
        Dialog dialog = new Dialog(jzvdContext, R.style.vi_style_dialog_progress);
    ...
    public void registerWifiListener(Context context) {
        ...
        mIsWifi = VideoUtils.isWifiConnected(context);
