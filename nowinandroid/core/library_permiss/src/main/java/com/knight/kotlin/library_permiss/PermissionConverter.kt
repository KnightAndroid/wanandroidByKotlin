...
internal object PermissionConverter {
    ...
    init
    {
        ...
        PERMISSION_NAME_MAP[PermissionGroups.SENSORS] = R.string.permission_body_sensors;
        PERMISSION_DESCRIPTION_MAP[R.string.permission_body_sensors] = R.string.permission_body_sensors_description;

        // 后台传感器权限虽然属于传感器权限组，但是只要是属于后台权限，都有独属于自己的一套规则
        PERMISSION_NAME_MAP[PermissionNames.BODY_SENSORS_BACKGROUND] = R.string.permission_body_sensors_background;
        PERMISSION_DESCRIPTION_MAP[R.string.permission_body_sensors_background] = R.string.permission_body_sensors_background_description;
