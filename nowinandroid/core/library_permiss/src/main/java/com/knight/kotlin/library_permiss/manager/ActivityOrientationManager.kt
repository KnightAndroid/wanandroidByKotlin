...
/**
 * @Description Activity 屏幕方向管理类
 * @Author knight
 * @Time 2025/6/8 16:36
 *
 */

object ActivityOrientationManager {
    ...
    /** 私有化构造函数  */
    private fun ActivityOrientationManager() {
    ...
    fun lockActivityOrientation( activity: Activity) {
        ...
        val sourceScreenOrientation = activity.requestedOrientation
        ...
        try {
            ...
            when (activity.resources.configuration.orientation) {
                Configuration.ORIENTATION_LANDSCAPE -> {
                    ...
                    activity.requestedOrientation = targetScreenOrientation
                    ACTIVITY_ORIENTATION_MAP[getIntKeyByActivity(activity)] = targetScreenOrientation
                }
    ...
    fun unlockActivityOrientation( activity: Activity) {
        ...
        val targetScreenOrientation = ACTIVITY_ORIENTATION_MAP[getIntKeyByActivity(activity)] ?: return
