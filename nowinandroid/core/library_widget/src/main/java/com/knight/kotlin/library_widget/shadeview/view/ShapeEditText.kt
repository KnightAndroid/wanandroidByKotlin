...
import com.knight.kotlin.library_widget.shadeview.styleable.ShapeEditTextStyleable
 ...
 * @organize
 * @Date 2024/9/5 11:25
 * @descript:支持直接定义 Shape 背景的 EditText
 */
class ShapeEditText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = android.R.attr.editTextStyle) :
    AppCompatEditText(context, attrs, defStyleAttr), IGetShapeDrawableBuilder, IGetTextColorBuilder {
