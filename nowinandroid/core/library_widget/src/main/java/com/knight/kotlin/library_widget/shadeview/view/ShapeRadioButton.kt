...
import com.knight.kotlin.library_widget.shadeview.styleable.ShapeRadioButtonStyleable
 ...
 * @organize
 * @Date 2024/9/5 14:22
 * @descript:支持直接定义 Shape 背景的 RadioButton
 */
class ShapeRadioButton @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = android.R.attr.radioButtonStyle) :
    AppCompatRadioButton(context, attrs, defStyleAttr), IGetShapeDrawableBuilder, IGetTextColorBuilder, IGetButtonDrawableBuilder {
    ...
    init {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.ShapeRadioButton, 0, R.style.ShapeRadioButtonStyle)
