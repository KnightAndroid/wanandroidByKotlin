 ...
 * @organize
 * @Date 2024/9/5 10:26
 * @descript:CheckBox 的 Shape 属性值
 */
class ShapeCheckBoxStyleable : IShapeDrawableStyleable, ITextColorStyleable, ICompoundButtonStyleable {
    /**
    ...
    override fun getSolidCheckedColorStyleable(): Int {
    ...
    override fun getStrokeCheckedColorStyleable(): Int {
    ...
    override fun getTextCheckedColorStyleable(): Int {
     ...
     */
    override fun getButtonDrawableStyleable(): Int {
        return R.styleable.ShapeCheckBox_shape_buttonDrawable
    }

    override fun getButtonPressedDrawableStyleable(): Int {
        return R.styleable.ShapeCheckBox_shape_buttonPressedDrawable
    }

    override fun getButtonCheckedDrawableStyleable(): Int {
        return R.styleable.ShapeCheckBox_shape_buttonCheckedDrawable
    }

    override fun getButtonDisabledDrawableStyleable(): Int {
        return R.styleable.ShapeCheckBox_shape_buttonDisabledDrawable
    }

    override fun getButtonFocusedDrawableStyleable(): Int {
        return R.styleable.ShapeCheckBox_shape_buttonFocusedDrawable
    }

    override fun getButtonSelectedDrawableStyleable(): Int {
