...
object ResArrayUtils {
    ...
    fun getName(
        context: Context,
        enum: com.knight.kotlin.library_common.enum.BaseEnum,
    ) = getNameByValue(
    ...
    fun getVoice(
        context: Context,
        enum: com.knight.kotlin.library_common.enum.VoiceEnum,
    ) = getNameByValue(
        res = context.resources,
        value = enum.id,
    ...
    fun getValueTextWithoutUnit(
        enum: com.knight.kotlin.library_common.enum.UnitEnum<Double>,
    ...
    fun getValueTextWithoutUnit(
        enum: com.knight.kotlin.library_common.enum.UnitEnum<Int>,
