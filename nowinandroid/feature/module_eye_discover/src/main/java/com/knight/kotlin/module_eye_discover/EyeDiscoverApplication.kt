package com.knight.kotlin.module_eye_discover
...
class EyeDiscoverApplication : ApplicationLifecycle {

    companion object {
        @SuppressLint("staticFieldLeak")
        lateinit var mEyeDiscoverApplication : EyeDiscoverApplication
    }



    override fun onAttachBaseContext(context: Context) {
        mEyeDiscoverApplication = this
    }
