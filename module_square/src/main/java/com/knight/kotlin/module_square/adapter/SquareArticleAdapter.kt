...
import com.knight.kotlin.module_square.entity.SquareArticleBean
 ...
 */
class SquareArticleAdapter(data:MutableList<SquareArticleBean>):BaseQuickAdapter<SquareArticleBean,BaseViewHolder>(
    R.layout.square_articles,data) {
    override fun convert(holder: BaseViewHolder, item: SquareArticleBean) {
        item.run {
            //作者
