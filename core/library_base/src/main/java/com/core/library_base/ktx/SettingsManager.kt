...
import com.core.library_base.enum.DarkMode
...
class SettingsManager private constructor(
    ...
    var backgroundAnimationMode: com.core.library_base.enum.BackgroundAnimationMode
        set(value) {
            CacheUtils.setBackgroundAnimationMode(value.id)
        }
        get() = com.core.library_base.enum.BackgroundAnimationMode.getInstance(
